...
use super::core_graphics::{
    ...
    K_CG_MOUSE_EVENT_SUBTYPE_TABLET_PROXIMITY, MACOS_TABLET_DEVICE_ID,
    NS_POINTING_DEVICE_TYPE_PEN, WACOM_CAPABILITY_MASK, WACOM_VENDOR_POINTER_TYPE_GENERAL_STYLUS,
